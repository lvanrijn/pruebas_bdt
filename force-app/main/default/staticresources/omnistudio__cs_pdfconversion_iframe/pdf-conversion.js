 ...
 */    
    ...
    */
    function getPDFNetInstance(){
        var PDFNetInstace;
        if(navigator.userAgent.toLowerCase().indexOf('firefox') >0 && typeof PDFNet === 'undefined'){
            PDFNetInstace = parent.PDFNet; 
        }
        else {
            PDFNetInstace = PDFNet; 
        }
        return PDFNetInstace;
    }
   ...
   function getCoreControlsInstance(){
        var coreControlsInstance;
        if(navigator.userAgent.toLowerCase().indexOf('firefox') >0 && typeof window.CoreControls === 'undefined'){
            coreControlsInstance = window.parent.CoreControls; 
        }
        else {
            coreControlsInstance = window.CoreControls; 
        }
        return coreControlsInstance;
    }    
